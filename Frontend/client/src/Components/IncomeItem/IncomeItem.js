...
function IncomeItem({
    ...
    //Category icon for income items
    const categoryIcon = () =>{
    ...
    return (
        ...
        <IncomeItemStyled indicator={indicatorColor}>
            ...
            <div className="icon">
                {/* Displays the appropriate icon based on the type (income/expense) */}
                {type === 'income' ? categoryIcon() : expenseCatIcon()}
            </div>

            {/* Div for the content of the income/expense item */}
            <div className="content">

                {/* Title and other details of the income/expense */}
                <h5>{title}</h5>

                {/*Inner content */}
                <div className="inner-content">

                    {/*Details about the income/expense */}
                    <div className="text">
...
// Styled component for the income/expense item
